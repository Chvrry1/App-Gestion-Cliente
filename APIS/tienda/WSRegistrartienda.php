...
$c_ruc=$_POST['ruc'];
$c_nomTienda=$_POST['nombreTienda'];
$c_idRrubro=$_POST['idRubro'];
$c_idusu=$_POST['usuario'];
$c_contraseña=$_POST['password'];

$consulta="CALL registrarTienda('".$c_apPaterno."','".$c_apMaterno."','".$c_nombres."','".$c_nidentificacion."','".$c_celular."','".$c_sexo."','".$c_email."','".$c_foto."','".$c_descripcion."','".$c_longitud."','".$c_latitud."','".$c_ruc."','".$c_nomTienda."','".$c_idRrubro."','".$c_idusu."','".$c_contraseña."')";
